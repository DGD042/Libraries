...
class SIATA(object):
    ...
    DESCRIPTION:
        ...
        from SIATA stations, the information should be
        located in a Folder. The name of the station should be
        the name of the folder and inside the folder the 
        information would be separated by variable and by 
        in different files with dates.
    _____________________________________________________________
    INPUT:
        :param PathData: A str, Path to the station information.
        :param Stations: A str, string with the station.
        :param Var: A str or list, string of the variable
