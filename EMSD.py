...
class EMSD(object):
	...
	def EDTXT(self,File=None,deli=None,colDates=(0,),colData=(1,),row_skip=1,flagHeader=True,rowH=0,row_end=None,num_NaN=None,flagDates=True,flagDatesAM=False,dtypeData=float,Date_Format=None):
		'''
		DESCRIPTION:
	...
	def Writemat(self,Dates,Data,savingkeys,datekeys=None,datakeys=None,pathout='',Names='Data'):
		...
		INPUT:
			...
			+ savingkeys: new keys for savng files.
	...
	def Ca_EC(self,Date=None,V1=None,op='mean',key=None,dtm=None):
		...
		# Daily data
		dt = int(24*60/dtm)
		DateD, DateDN, VD,VmaxD,VminD = self.Ca_E(Date,V1,dt,1,op=op,flagMa=True,flagDF=False)
